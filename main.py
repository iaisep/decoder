...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://vault-guard-pay.lovable.app","https://secure-payment.universidadisep.com/"],
...
def save_transaction_to_db(
    ...
    db_transaction = CardholderTransaction(
        ...
        card_last_four=card_data.get("cardNumber", "")[-4:] if card_data.get("cardNumber") else "",
